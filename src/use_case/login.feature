Feature: log in user and sign up to user
  Scenario: valid login
    ...
    When set username "haya" and password "123"
    Then login succeed
  ...
  Scenario Outline: Owner needs to Create Account
    ...
    Examples:
      ...
      | "salma"     | "1234"   | "Nablus" |"Nablus street"|"54G"           |  "0594507933" | "salma@gmail.com" |"o"  |"NY sweet"|6     |
      | "AbuAhmad"     | "11"     | "Nablus" |"Nablus street"|"54G"           | "0594507933"  | "ahmad@gmail.com" |"s"  |"Abu ahmad shop"|5|
